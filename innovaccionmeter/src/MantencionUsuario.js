...
export default class MantencionUsuario extends Component {
    ...
    ultimatum(obj) {    
        //enviar_ultimatum
        if (obj.status === "1") {
            return <u><a className="text-dark" href="/InnovAccionMeter/#" onClick={() => this.enviar_ultimatum(obj)}>Envia Ultimatum</a></u>
        } else {
            return ""
        }
    }
            ...
            <div className="px-2">
                ...
                <div className="row">
                    <div className="col-md-6 py-3 text-center">
                        <u><a className="text-dark" href="/InnovAccionMeter/#" onClick={() => this.crear_usuario(this.props.IdEmpresa, this.props.tipo_encuesta, this.props.Sigla)}>--- Crea Nuevo Usuario ---</a></u>
                    </div>
                    <div className="col-md-6 py-3 text-center">
                        <u><a className="text-dark" href="/InnovAccionMeter/#" onClick={async () => await this.enviar_invitaciones()} >---Envia Invitaciones ---</a></u>
                    </div>
                </div>
                    ...
                    datos.map((obj, index) => {
                        return (
                            <div className={division} key={index}>
                                ...
                                <div className={contenido_2} style={{ "border": "1px solid #c9c9c9" }}><u><a className="text-dark" href="/InnovAccionMeter/#" onClick={() => this.modifcar_usuario(obj)}>{obj.Nombre}</a></u></div>
